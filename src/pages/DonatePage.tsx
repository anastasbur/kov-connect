        ...
        <div className="container-kovcheg">
          <div className="max-w-2xl">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed max-w-xl">
              Ваши пожертвования — это экстренное жильё для преследуемых,
              адвокаты для задержанных, бесплатные консультации и клубы.
              «Ковчег» существует только благодаря солидарности.
            </p>
          </div>
        </div>
      </section>
