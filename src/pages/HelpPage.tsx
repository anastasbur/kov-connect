...
import {
  ...
  ArrowUpRight, ChevronDown, ChevronUp, AlertCircle, Send, Shield
} from "lucide-react";
...
const services = [
  ...
  },
  {
    ...
    badge: "Бесплатно",
    title: "Правовая помощь при преследовании",
    ...
    stat: "170 000 получили юридическую помощь",
    details: [
      {
  ...
  },
  {
    ...
    subtitle: "Индивидуально · Без осуждения",
    description:
  ...
  },
  {
    ...
    badge: "Бесплатно",
    title: "Ковчег VPN",
    subtitle: "Обход блокировок · Безопасный доступ",
    description:
      "Бесплатный VPN «Ковчега» помогает обходить блокировки и безопасно оставаться на связи — особенно тем, кто внутри России. Подключение и инструкции — через Telegram-бот.",
    stat: "",
    cta: { label: "Подключить VPN", href: "https://t.me/kovchegvpnbot" },
  },
  {
    id: "languages",
    icon: Globe,
